...
export default function BlockPaletteModal({ visible, allBlockTypes, onClose, onSelect, onCreateSmart }: BlockPaletteModalProps) {
  ...
  return (
    <div className="absolute inset-0 z-[2000] flex items-center justify-center bg-black/60 p-5">
      <div className="w-full max-w-2xl rounded-3xl p-1 bg-gradient-to-br from-pink-400/30 via-purple-400/30 to-blue-400/30 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
        <div className="rounded-2xl bg-neutral-900 text-white shadow-2xl border border-white/10 overflow-hidden backdrop-blur-sm">
